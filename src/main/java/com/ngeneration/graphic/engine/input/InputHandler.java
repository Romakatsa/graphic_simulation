package com.ngeneration.graphic.engine.input;
...
public class InputHandler {
    ...
    private final List<KeyboardEvent> keyboardEvents = new ArrayList<>();
    private final List<KeyboardEvent> keyboardEventsForAdding = new ArrayList<>();
    private final List<MouseEvent> mouseEventsForAdding = new ArrayList<>();
...
//        System.out.println("updateKeyboardEventsType: " + System.identityHashCode(keyboardEvents )+ ": " + keyboardEvents.size());
...
//        }
//        System.out.println("this: " + this);
//        System.out.println("createKeyboardEvent: " + System.identityHashCode(keyboardEvents) + ": " + keyboardEvents.size());
//        System.out.println("createKeyboardEvent: " + System.identityHashCode(keyboardEventsForAdding) + ": " + keyboardEventsForAdding.size());
        keyboardEventsForAdding.add(event);
